...
class PI05FullConfig(PreTrainedConfig):
    ...
    subtask_max_length: int = 32  # Padded length of tokenized subtask targets (with appended EOS)
    ...
    # π0.5 packs the discretized state (32 bins) into the prompt "Task: ..., State: <bins>\n",
    # which measures ~130 tokens with the PaliGemma tokenizer. The stock default of 48 would
    # silently truncate all state bins, so use openpi's π0.5 length of 200.
